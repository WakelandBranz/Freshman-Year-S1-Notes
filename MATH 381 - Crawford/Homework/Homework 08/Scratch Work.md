...
From the inductive hypothesis we know that $a_k = 5^k + 2$ and $a_k-1 = 5^{k - 1} + 2$.
So, substituting these into our recursive formula we get $$a_{k + 1} = 6(5^k + 2) - 5(5^{k - 1} + 2) = 6(5^k + 2) - (5)\left( \frac{1}{5} \right)(5^k + 2) = 6(5^k + 2) - (5^k + 2) = 5(5^k + 2)$$
We know that $5^{k + 1} + 2 = 5(5^k + 2) = a_k + 1$ so this proves our inductive hypothesis.
